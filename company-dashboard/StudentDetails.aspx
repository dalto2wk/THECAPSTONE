<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentDetails.aspx.cs" Inherits="company_dashboard_StudentDetails" %>
...
<body>
	...
	<div class="container-fluid" id="wrapper">
		<div class="row">
			...
			<div class="sitelogo">
				<img src="/img/logo.jpg" alt="logo"><a href="LandingPage.aspx"></a>
			</div>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
                ...
                <label class="col-md-3 col-form-label" runat="server">First Name</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblFirstName"></label>
                <br />
                <label class="col-md-3 col-form-label" runat="server">last Name</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblLastName"></label>
                <br />
                <label class="col-md-3 col-form-label" runat="server">Academic Year</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblAcademicYear"></label>
                <br />
                ...
                <br />
                <label class="col-md-3 col-form-label" runat="server">Interests</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblInterests"></label>
                <br />
                <label class="col-md-3 col-form-label" runat="server">GPA</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblgpa"></label>
                <br />
                <label class="col-md-3 col-form-label" runat="server">School</label>
                <label class="col-md-3 col-form-label" runat="server" id="lblSchool"></label>
