								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<div class="table-responsive">
											...
											<asp:gridview id="table" class="table table-striped" runat="server" AutoGenerateColumns="False" DataKeyNames="applicationID" DataSourceID="SqlDataSource1">
                                                <Columns>
										    ...
										    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectConnectionString %>" SelectCommand="SELECT [applicationID], [jobTitle], [companyName] FROM [Application]"></asp:SqlDataSource>
										</div>
									</div>
								</div>
								<div class="card mb-8">
